...
if __name__ == '__main__':
    ...
    plt.title('Receiver operating characteristic of selected/extracted features dataset')
    plt.legend(loc="lower right")
    plt.show()

    #
    for model_name in model_names:
        fpr, tpr, auc = performance_util.calculate_holdout_roc_auc(model_name, status)
        plt.plot(fpr, tpr,
