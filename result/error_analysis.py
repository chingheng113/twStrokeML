...
all_wrong_h_df = all_wrong_h_df[np.append(['ICASE_ID', 'IDCASE_ID', 'MRS_TX_3'], selected_features_h)]
...
all_right_h_df = all_right_h_df[np.append(['ICASE_ID', 'IDCASE_ID', 'MRS_TX_3'], selected_features_h)]
